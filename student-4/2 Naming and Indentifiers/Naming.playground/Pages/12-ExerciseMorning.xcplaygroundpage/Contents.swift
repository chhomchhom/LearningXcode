...
let totalTimeSpend = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging
...
let thingsILikeToDo = uploadPhotos
let thingsHaveToDo = brushTeeth + chooseClothes + shower + goJogging
